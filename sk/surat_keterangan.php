...
if (empty($_SESSION['admin'])) {
    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 2) {
        ...
        if (isset($_REQUEST['act'])) {
            ...
            switch ($act) {
                case 'add':
                    include "tambah_skh.php";
                    break;
                case 'edit':
                    include "edit_skh.php";
                    break;
                case 'print':
                    include "cetak_skh.php";
                    break;
                case 'del':
                ...
                <div class="col s12">
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper #ab2524 red darken-4">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=sk" class="judul"><i class="material-icons">mail</i> Surat Keterangan Aktif</a></li>
                                        <li class="waves-effect waves-light">
                                            <a href="?page=sk&act=add"><i class="material-icons md-24">add_circle</i> Tambah Data</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col m5">
            ...
            if (isset($_REQUEST['submit'])) {
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        if (!empty($row['file'])) {
                            echo ' <strong><a href="?page=gsm&id_surat=' . $row['id_surat'] . '">' . $row['file'] . '</a></strong>';
                        } else {
                        ...
                        if ($_SESSION['id_user'] != $row['id_user'] and $_SESSION['id_user'] != 1) {
                            echo '<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat=' . $row['id_surat'] . '" target="_blank">
                                  ...
                                  <a class="btn small blue waves-effect waves-light" href="?page=sk&act=edit&id_surat=' . $row['id_surat'] . '">
                                            <i class="material-icons">edit</i> EDIT</a>';
                        } else {
                            echo '<a class="btn small blue waves-effect waves-light" href="?page=sk&act=edit&id_surat=' . $row['id_surat'] . '">
                                                <i class="material-icons">edit</i> EDIT</a>
                                            <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat=' . $row['id_surat'] . '" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>
                                            <a class="btn small deep-orange waves-effect waves-light" href="?page=sk&act=del&id_surat=' . $row['id_surat'] . '">
                ...
                if ($cdata > $limit) {
                    ...
                    if ($pg > 1) {
                        $prev = $pg - 1;
                        echo '<li><a href="?page=sk&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=sk&pg=' . $prev . '"><i class="material-icons md-48">chevron_left</i></a></li>';
                    } else {
                    ...
                    for ($i = 1; $i <= $cpg; $i++)
                        if ($i != $pg) {
                            echo '<li class="waves-effect waves-dark"><a href="?page=sk&pg=' . $i . '"> ' . $i . ' </a></li>';
                        } else {
                            echo '<li class="active waves-effect waves-dark"><a href="?page=sk&pg=' . $i . '"> ' . $i . ' </a></li>';
                        }

                    //last and next pagging
                    if ($pg < $cpg) {
                        $next = $pg + 1;
                        echo '<li><a href="?page=sk&pg=' . $next . '"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=sk&pg=' . $cpg . '"><i class="material-icons md-48">last_page</i></a></li>';
                    } else {
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    echo '<tr><td colspan="5"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?page=sk&act=add">Tambah data baru</a></u></p></center></td></tr>';
                }
                echo '</table>
                        </div>
                    </div>

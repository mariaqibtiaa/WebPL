    	...
    	if(mysqli_num_rows($query) > 0){
            ...
            if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                echo '<script language="javascript">
                        ...
                        window.location.href="./admin.php?page=sk";
                      </script>';
            } else {
				...
				<div class="row jarak-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
        	                <a href="?page=sk&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                		...
                		if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=sk&act=del&id_surat='.$id_surat.'";
                                  </script>';
                		}
                	} else {

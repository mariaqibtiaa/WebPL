...
<div id="main">
    ...
    if (isset($_REQUEST['submit'])) {
                        ...
                        if (!preg_match("/^[a-zA-Z0-9., -]*$/", $perihal_sm)) {
                            ...
                            if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                ...
                                if ($file != "") {
                                    ...
                                    if (in_array($eks, $ekstensi) == true) {
                                        if ($ukuran < 2300000) {
                                            ...
                                            if (!empty($file)) {
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_sm='$no_sm',perihal_sm='$perihal_sm',asal_sm='$asal_sm',isi_sm='$isi_sm',tgl_surat='$tgl_surat',file='$nfile' WHERE id_sm='$id_sm'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET asal_sm='$asal_sm',no_sm='$no_sm',isi_sm='$isi_sm',perihal_sm='$perihal_sm',tgl_surat='$tgl_surat',file='$nfile' WHERE id_sm='$id_sm'");
                                    ...
                                    $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET asal_sm='$asal_sm',no_sm='$no_sm',isi_sm='$isi_sm',perihal_sm='$perihal_sm',tgl_surat='$tgl_surat' WHERE id_sm='$id_sm'");
        ...
        $query = mysqli_query($config, "SELECT id_sm, asal_sm, no_sm, isi_sm, perihal_sm, tgl_surat, file FROM tbl_surat_masuk WHERE id_sm='$id_sm'");
        list($id_sm, $asal_sm, $no_sm, $isi_sm, $perihal_sm, $tgl_surat, $file) = mysqli_fetch_array($query);

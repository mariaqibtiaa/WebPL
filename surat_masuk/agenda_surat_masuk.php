            ...
            echo '
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <p class="warna agenda">Agenda Surat Masuk dari tanggal <strong>' . $tgl = date('d M Y ', strtotime($dari_tanggal)) . '</strong> sampai dengan tanggal <strong>' . $tgl = date('d M Y ', strtotime($sampai_tanggal)) . '</strong></p>
                        </div>
                    </div>
